...
<![endif]-->
<title>DCS-管理 V1.1</title>
<meta name="keywords" content="DCS-管理 V1.1">
<meta name="description" content="DCS-管理 V1.1">
</head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">DCS-管理 </a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 百度抓取内容<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${ctx }/collection/toCountryDataList" data-title="国家内容" href="javascript:void(0)">国家内容</a></li>
					<li><a data-href="${ctx }/collection/toCountryCrawler" data-title="百度国家抓取情况" href="javascript:void(0)">百度国家抓取情况</a></li>
				</ul>
			</dd>
	</dl>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctx}/css/H-ui.admin_v3.0/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
