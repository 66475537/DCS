 ...
 *
 */
public class MyNewsCrawler extends BreadthCrawler {

	
	
    public MyNewsCrawler(String crawlPath, boolean autoParse) {
        super(crawlPath, autoParse);
        /*种子页面*/
        this.addSeed("http://www.baidu.com/s?wd=%E4%B8%AD%E5%9B%BD");

        /*正则规则设置*/
        /*爬取符合 http://news.hfut.edu.cn/show-xxxxxxhtml的URL*/
        this.addRegex("http://www.baidu.com/link?url=*");
        /*不要爬取 jpg|png|gif*/
...
//        this.addRegex("-.*#.*");
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        /*判断是否为新闻页，通过正则可以轻松判断*/
        if (page.matchUrl("http://baike.baidu.com/link?url=*")) {
            /*we use jsoup to parse page*/
            Document doc = page.getDoc();

            /*extract title and content of news by css selector*/
            String title = page.select("a>em").first().text();
...
//            System.out.println("content:\n" + content);
    ...
    public static void main(String[] args) throws Exception {
        MyNewsCrawler crawler = new MyNewsCrawler("crawl", true);
        /*线程数*/
